...
(define (encode-symbol symbol tree)
  (if (leaf? tree)
    (if (eq? (symbol-leaf tree) symbol)
      nil
      (error "symbol is not in tree" symbol))
...
;pra2.70
(define rockpair '((A 2)(NA 16)(BOOM 1)(SHA 3)(GET 2)(YIP 9)(JOB 2)(WAH 1)))

;(define rockmsg '(Get a job Sha na na na na na na na na Get a job Sha na na na na na na na na Wah yip yip yip yip yip yip yip yip yip Sha boom))
(define rockmsg '(GET A JOB SHA NA NA NA NA NA NA NA NA GET A JOB SHA NA NA NA NA NA NA NA NA WAH YIP YIP YIP YIP YIP YIP YIP YIP YIP SHA BOOM))

(define rocktree (generate-huffman-tree rockpair))
